...
var ASM_CONSTS = {
  93325: () => { if (document.fullscreenElement) return 1; },  
 93371: () => { return Module.canvas.width; },  
 93403: () => { return parseInt(Module.canvas.style.width); },  
 93451: () => { document.exitFullscreen(); },  
 93478: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 93550: () => { if (document.fullscreenElement) return 1; },  
 93596: () => { return Module.canvas.width; },  
 93628: () => { return screen.width; },  
 93653: () => { document.exitFullscreen(); },  
 93680: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93813: () => { return window.innerWidth; },  
 93839: () => { return window.innerHeight; },  
 93866: () => { if (document.fullscreenElement) return 1; },  
 93912: () => { return Module.canvas.width; },  
 93944: () => { return parseInt(Module.canvas.style.width); },  
 93992: () => { if (document.fullscreenElement) return 1; },  
 94038: () => { return Module.canvas.width; },  
 94070: () => { return screen.width; },  
 94095: () => { return window.innerWidth; },  
 94121: () => { return window.innerHeight; },  
 94148: () => { if (document.fullscreenElement) return 1; },  
 94194: () => { return Module.canvas.width; },  
 94226: () => { return screen.width; },  
 94251: () => { document.exitFullscreen(); },  
 94278: () => { if (document.fullscreenElement) return 1; },  
 94324: () => { return Module.canvas.width; },  
 94356: () => { return parseInt(Module.canvas.style.width); },  
 94404: () => { document.exitFullscreen(); },  
 94431: ($0) => { Module.canvas.style.opacity = $0; },  
 94469: () => { return screen.width; },  
 94494: () => { return screen.height; },  
 94520: () => { return window.screenX; },  
 94547: () => { return window.screenY; },  
 94574: () => { return window.devicePixelRatio; },  
 94610: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94663: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94714: () => { Module.canvas.style.cursor = 'none'; },  
 94751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95007: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95058: () => { if (document.pointerLockElement) return 1; },  
 95105: () => { if (document.fullscreenElement) return 1; },  
 95151: () => { return window.innerWidth; },  
 95177: () => { return window.innerHeight; }
};
