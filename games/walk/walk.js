...
var ASM_CONSTS = {
  94333: () => { if (document.fullscreenElement) return 1; },  
 94379: () => { return Module.canvas.width; },  
 94411: () => { return parseInt(Module.canvas.style.width); },  
 94459: () => { document.exitFullscreen(); },  
 94486: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 94558: () => { if (document.fullscreenElement) return 1; },  
 94604: () => { return Module.canvas.width; },  
 94636: () => { return screen.width; },  
 94661: () => { document.exitFullscreen(); },  
 94688: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94821: () => { return window.innerWidth; },  
 94847: () => { return window.innerHeight; },  
 94874: () => { if (document.fullscreenElement) return 1; },  
 94920: () => { return Module.canvas.width; },  
 94952: () => { return parseInt(Module.canvas.style.width); },  
 95000: () => { if (document.fullscreenElement) return 1; },  
 95046: () => { return Module.canvas.width; },  
 95078: () => { return screen.width; },  
 95103: () => { return window.innerWidth; },  
 95129: () => { return window.innerHeight; },  
 95156: () => { if (document.fullscreenElement) return 1; },  
 95202: () => { return Module.canvas.width; },  
 95234: () => { return screen.width; },  
 95259: () => { document.exitFullscreen(); },  
 95286: () => { if (document.fullscreenElement) return 1; },  
 95332: () => { return Module.canvas.width; },  
 95364: () => { return parseInt(Module.canvas.style.width); },  
 95412: () => { document.exitFullscreen(); },  
 95439: ($0) => { Module.canvas.style.opacity = $0; },  
 95477: () => { return screen.width; },  
 95502: () => { return screen.height; },  
 95528: () => { return window.screenX; },  
 95555: () => { return window.screenY; },  
 95582: () => { return window.devicePixelRatio; },  
 95618: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95671: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 95722: () => { Module.canvas.style.cursor = 'none'; },  
 95759: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96015: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96066: () => { if (document.pointerLockElement) return 1; },  
 96113: () => { if (document.fullscreenElement) return 1; },  
 96159: () => { return window.innerWidth; },  
 96185: () => { return window.innerHeight; }
};
