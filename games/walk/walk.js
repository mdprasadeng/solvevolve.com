...
/** @suppress{checkTypes} */ function _emscripten_run_script_int(ptr) {
  ptr >>>= 0;
...
var ASM_CONSTS = {
  ...
  94443: () => Module.canvas.width,
  94475: () => parseInt(Module.canvas.style.width),
  94523: () => {
  ...
  94885: () => window.innerWidth,
  94911: () => window.innerHeight,
  94938: () => {
    if (document.fullscreenElement) return 1;
  },
  94984: () => Module.canvas.width,
  95016: () => parseInt(Module.canvas.style.width),
  95064: () => {
    if (document.fullscreenElement) return 1;
  },
  95110: () => Module.canvas.width,
  95142: () => screen.width,
  95167: () => window.innerWidth,
  95193: () => window.innerHeight,
  95220: () => {
    if (document.fullscreenElement) return 1;
  },
  95266: () => Module.canvas.width,
  95298: () => screen.width,
  95323: () => {
    document.exitFullscreen();
  },
  ...
  95396: () => Module.canvas.width,
  95428: () => parseInt(Module.canvas.style.width),
  95476: () => {
    document.exitFullscreen();
  },
  95503: $0 => {
  ...
  95541: () => screen.width,
  95566: () => screen.height,
  95592: () => window.screenX,
  95619: () => window.screenY,
  95646: () => window.devicePixelRatio,
  95682: $0 => {
  ...
  96223: () => window.innerWidth,
  96249: () => window.innerHeight
};
